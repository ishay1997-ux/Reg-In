...
**לכל שאר הסיטואציות** — 📚 **[ספריית הפרומפטים המצביים](docs/guides/prompt_library.md)** (המקור הקנוני, כולל P1): חילוץ כשמשהו השתבש, סטייה מהתוכנית, ביטול שינוי (undo), merge conflict, רגרסיה אחרי משיכה, שיחת קריאה-בלבד מקבילה, "עשיתי ידנית", רישום שאלה פתוחה ל-§7, ופרומפט למידה. מוצאים את הסיטואציה בטבלה שם ומדביקים.
...
| [docs/guides/prompt_library.md](docs/guides/prompt_library.md) | 📚 **ספריית הפרומפטים המצביים** (P1–P11): חילוץ, סטייה, undo, קונפליקט, רגרסיה, "עשיתי ידנית" ועוד — לפי סיטואציה |
