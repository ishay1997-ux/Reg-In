...
**What did NOT happen:** no UI yet (Phase 3), no route swap, the second migration not applied, STATUS/LOG updated here only under the Stop hook — the main checkout's copies belong to the seed session.
