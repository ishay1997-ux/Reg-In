...
| 10 | ~~סיסמאות בדיקה בטקסט גלוי ב-`docs/CHANGELOG.md`~~ — ✅ **נסגר (06/07/2026, באישור ישי):** הבלוק הוסר מהקובץ והוחלף בהפניה לערוץ פרטי. ⚠️ הסיסמאות הישנות נשארו בהיסטוריית git — ולכן **ישי מחליף את הסיסמאות עצמן ב-Supabase** (סיסמה חדשה = ההיסטוריה לא מסוכנת יותר) | `docs/CHANGELOG.md` | ✅ סגור (בכפוף להחלפת הסיסמאות בפועל) |
...
| P2 #10 | ✅ נסגר 06/07 — הבלוק הוסר מ-CHANGELOG; החלפת סיסמאות ב-Supabase אצל ישי |
