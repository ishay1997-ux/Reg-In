...
* ⏸️ 12 התרחישים המורחבים על טבלת `customers` — **נדחה רשמית למודול 2** (החלטת ישי, 02/07/2026; ראו צעד 12). תרחישי הליבה 5–12 של מודול 1 אומתו חיים; רק שכפול RLS על `customers` נדחה.
