...
| **Active step** | **1.1–1.3** — the three migration files are WRITTEN (CR=0) and await Ishay's typed echoes; **Phase 2 (2.1–2.5) runs in parallel on four builder agents** (no DB dependency; unit tests are mocked) |
