...
| 4.2 | Rejection + expiry flows E2E (7 reasons, notes, cron simulation) 🔻🤖 — 🔗 **ONE ROUND with 4.3** | ⬜ |
| 4.3 | e2e/quotes.spec.js + e2e/prices.spec.js suites 🔻🤖 — 🔗 **ONE ROUND with 4.2** (+ the two 3.4 debts below) | ⬜ |
