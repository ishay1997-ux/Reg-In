...
| Status | 🔨 **Phase 4 is OPEN — 4.1 · 4.2 · 4.3 CLOSED 31/07/2026. Next: 4.3b (coverage residue — ⛔ BEFORE 4.4, Ishay approved 22:18), then 4.4 (regression), then the 4.5 👤 gate.** Phase 1+2+3 closed (see done-tables below). ⚠️ Before starting: read **both** boxes beside step 4.2 — 🧰 (the rolled-back battery, built and proven, do not re-invent it) **and 🔗 (why 4.2 and 4.3 are one round — closing 4.2 alone closes half a round)**. |
