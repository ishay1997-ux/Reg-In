...
>
> **קורא:** ישי. **את הפרוצדורה עצמה** *(מה שקלוד קורא)* תמצא בסקיל
> `.claude/skills/module-discovery/` — **הקובץ הזה אומר לך מתי להפעיל אותו.**
> *(עודכן 13/08/2026: היה קובץ-פרומפט להדבקה, `prompt_module_discovery.md`, והוא הפך לסקיל
> שנדלק מהמשפט שאתה כותב ממילא — "אנחנו עושים Discovery מלא למודול N".)*
...
לפי .claude/skills/module-discovery/template.md, "Stage 3 · Handoff" בלבד —
שלבים 0-2 בוצעו, אל תחזור עליהם.

בתוך שלב 3 יש "🛡️ Cross-check before handoff" — שש הצלבות מוגדרות.
