...
מיילים ותזכורות אוטומטיות: תזכורת לדיילת 24 שעות לפני אירוע, "שכחתי סיסמה" מלא, והפעלת Leaked Password Protection (חוב מודול 1). ⚠️ **עדכון §7.42 (07/07/2026):** **מעברי-הסטטוס הטהורים** (פקיעת הצעה 30 יום, מעבר "אירוע הסתיים") אינם כאן — הם `pg_cron` **שנבנה כבר במודול 3**; מודול 10 בונה את ה-**Edge Function המתוזמנת לשליחות** (תזכורת 24ש' ומיילים אחרים) ומרחיב מעליו.
