...
- ⏳ הגדרת 5 הדו"חות מדויקת באפיון; ההכרעה הטכנית (Views ב-DB מול חישוב בצד לקוח) — בבנייה. **אבל (07/07 ערב):** דו"ח-הרווחיות תלוי בהכרעות שנפתחו בביקורת-האפיון — **§7.52** (רווח נשמר/נגזר + ₪/%) ו-**§7.58** (נוסחת סטיית-התקציב), ודו"ח-הלקוחות ב-**§7.37** (חלון ממוצע-המשוב). צפוי שיוכרעו במודולים 6/8; אם לא — לעצור כאן ולהכריע.
