...
1. **‏`docs/specs/module_05_logistics/screens-approved.md` — טרם נוצר, וזהו הצעד הבא ולא השמטה**
   *(נמדד `22/08/2026`)*. **בתיקייה חמישה קבצים:** `data-set.md` · `design-contract.md` ·
   `discovery-log.md` · `processes-approved.md` · `world-sources.md`.
   ‏`processes-approved.md` מצהיר בכותרתו *"שלב 1 סגור"* — **שבעת כרטיסי-התהליך מאושרים · `M = 3`
   משטחים · 34 הכרעות ברשם** — ומגדיר את **שלב 2** כ*"מוקאפ + כרטיס-מסך לכל אחד משלושת המשטחים,
   אל `screens-approved.md`"*. ⇒ **חוזה-העיצוב אינו יודע מה מצויר בכל מסך — רק איך.**
