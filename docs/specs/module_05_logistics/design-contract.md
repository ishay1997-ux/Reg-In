...
‏🚫 **לא הכרעתי אם הסרת-פריט-לוגיסטי היא מחיקה או ארכוב** — זו הכרעת-מוצר של ישי, וה-`processes-approved.md`
של המודול צריך לענות עליה **לפני** שהדיאלוג מצויר. ⇒ **אייקון הפח נבחר רק אחרי שההכרעה קיימת.**
