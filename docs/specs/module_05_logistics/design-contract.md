...
**סיכום לפי משפחה** (סכום כל הגוונים): ‏**slate ≈ 894 · teal ≈ 154 · amber ≈ 104 · red ≈ 102 · green ≈ 47.**
בנוסף, מחוץ לצורת-הביטוי של החיפוש: `bg-white` ×81 · `text-white` ×35.
...
‏`🔗 מראת ⑰ — SSOT: processes-approved.md (לא לערוך כאן)` — **הסרה מותרת אך ורק במצב `טרם החל`,
והיא מחיקה של השורה** *(שורה שלא הוזמנה אינה ראיה לכלום)*; **ב-`הוזמן`/`מוכן` היא נחסמת**, כי
השורה הפכה לראיית-חיוב. ⇒ **אייקון הפח לגיטימי בדיוק בשורות שההסרה מותרת בהן.**
...
<main>
  ...
  <!-- גלולות-מסנן: נבחר = טורקיז בהיר; מושבת נשאר ומוסבר -->
  <div style="display:flex; flex-wrap:wrap; gap:8px; margin-bottom:16px">
    <button class="pill on">כל האירועים</button>
    <button class="pill">השבוע</button>
    <button class="pill on warn">טרם מוכנים</button>
    <button class="pill" disabled title="אין עדיין פריטים שבוטלו">בוטלו</button>
  </div>
  ...
  <section class="card">
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            <div class="item-name">שולחן קבלה מעוצב</div>
            <div class="item-sku"><span class="ltr">B-REG-TBL</span></div>
          </td>
          <td>
        ...
        <tr>
          <td>
            <div class="item-name">תג שם ממותג</div>
        ...
        <tr>
          <td>
            <div class="item-name">רולאפ כניסה</div>
            <div class="item-sku"><span class="ltr">B-REG-RUP</span></div>
          </td>
...
1. **‏`docs/specs/module_05_logistics/screens-approved.md` — לא קיים.** בתיקייה יש רק
   `discovery-log.md` ו-`processes-approved.md`, וזה האחרון מצהיר בעצמו *"שלב 0 · טרם התחיל שלב 1"* ו-
   *"הקובץ הזה עדיין ריק מתוכן-מוצרי"*. ⇒ **חוזה-העיצוב אינו יודע מה מצויר בכל מסך — רק איך.**
...
3. **‏`docs/mockups/logistics-screen/` מכיל `01.png` ו-`02.png` בלבד** — אין שם HTML ואין `approved/`.
   ⇒ **אין מוקאפ-לוגיסטיקה קודם להתיישר מולו**, וזה דווקא טוב: אין דריפט לרשת.
