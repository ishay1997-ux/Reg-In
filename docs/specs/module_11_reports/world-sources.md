...
**זו המוסכמה, ומתאימה כאן ללא סטייה — נכון לרגע-הכתיבה (06/09/2026 16:4X); ר' התיקון המתוארך מיד למטה.**

✏️ 23:0X 🔗 **מראת הכרעה 18 — SSOT: processes-approved.md (לא לערוך כאן):** הפרקטיקה ח8-9 שתועדה
למעלה **הוחלפה** ב-06/09/2026 20:5X — *"שמות-הדוחות: שם קצר בניווט, השאלה ככותרת-משנה בתוך
הדף. **לא** מספרים ('דוח 6') ו**לא** שאלה כתווית-ניווט"* (ישי: *"אצלנו בעבודה זה פשוט מספר…
זה נורא מעצבן"*). **טבלת ⑥/📑 שצוינה למעלה כבר עודכנה לפי הכרעה 18** — התיעוד כאן היה מפגר
אחריה (ר' `processes-approved.md ⚖️5-ב`). **שני מקורות-העולם שהכרעה 18 מצטטת לשם-הקצר:**
[Power BI style guidelines — TrueCue](https://truecue.com/resources/blog/power-bi-style-guidelines/)
· [Tableau naming conventions — Biztory](https://biztory.com/blog/tableau-naming-conventions)
*(ומקור שלישי נלווה שם: [Graphed — renaming reports](https://www.graphed.com/blog/how-to-rename-a-report-in-powerbi))*.
**ארבע-שאלות-ההתאמה עדיין טריוויאליות** — זו עדיין החלטת-ניסוח בלבד; מה שהשתנה הוא הניסוח
עצמו, לא ההתאמה שלו.
