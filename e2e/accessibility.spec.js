...
//
// ✅ **10/09/2026 — ההכרעה התקבלה, וחצי-הטורקיז נסגר.** ישי: *"לא אכפת לי שתשנה… בתנאי שאתה
// מרוצה מהתוצאה"*. ‏`--primary` ‏`#0D9488` ⇒ `#0F766E` (3.74 ⇒ **5.24:1**, ‏129 כפתורים), ו-41
// משטחי `bg-teal-600` שנשאו טקסט לבן ⇒ `bg-teal-700` (3.67 ⇒ **5.36:1**), עם `hover` ל-800.
// ‏6 מופעי `bg-teal-600` שאינם נושאים טקסט **נשארו** — הם עוברים את סף 3:1 לסימון-לא-טקסט,
// והם שומרים את גוון-המותג במקום שבו הוא רק אקצנט. ‏`bg-amber-600` היחיד עם טקסט לבן ⇒ 700.
// 🔴 **ומה שעדיין פתוח, ולכן `CONTRAST_IS_ADVISORY` לא בוטל:** `text-slate-400` (2.63) —
// חוב-נגישות מתוכנן ל-M12 (`architecture_and_qa_roadmap.md:141`), ו**גבולות-פקדים** ב-1.23–1.49
// מול 3:1 של WCAG 1.4.11 — נמדד ע"י ארבעה סוכנים בלתי-תלויים, רשום ב-`PROJECT_MASTER §6`.
