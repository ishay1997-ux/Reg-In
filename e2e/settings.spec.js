...
// (המנכ"ל, כל השורות) ו-`/my-settings` (בעלת-תפקיד, רק השורות שבבעלותה).
// ‏🔴 בלי מספר, במכוון (16/09/2026): כאן עמד "43 השורות", ומודול 11 הוסיף ארבעה פרמטרים ⇒ 47.
//    הבדיקה עצמה אינה סופרת שורות, ולכן המספר היה קישוט שמתיישן.
//
