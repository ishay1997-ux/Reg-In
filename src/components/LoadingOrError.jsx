...
// onRetry אופציונלי: כשמסופק - גרסה מלאה (עטיפה+role=alert+כפתור "נסי שוב"); כשלא - פסקת-שגיאה בלבד.
//
...
// 🆕 `retryLabel` (19/08/2026, צעד 3.0 ε של מודול 6) — פרמטר-רשות. ✏️ 08/09/2026 (שלב 2 של
// ליל-שכתוב-הטקסט, מדריך-הסגנון הנעול §1): ברירת-המחדל עצמה הפכה ל-"נסי שוב" (לשון-נקבה —
// S-28, כל חמש המשתמשות נשים) — קוראים שהעבירו `retryLabel="נסי שוב"` במפורש (מודול 6) מעבירים
// כעת ערך זהה לברירת-המחדל; הסרת ה-prop המיותר היא ניקיון של אותם מודולים, לא כאן.
