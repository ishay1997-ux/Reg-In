    ...
    <div className="p-6">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
        ...
        <div className="flex gap-2">
          ...
          <StatTile
            // ✏️ 25/09/2026 (screens-pass s04): "71.3% · 837 מתוך 1174" נמדד על כל ההצעות, והלשוניות מתחת מציגות
            // חלון (ברירת-מחדל 3 חודשים, 196 שורות) — בלי מילה שמבחינה. אותה מילה כמו במסך הכספים.
            label="שיעור אישור · כל הזמנים"
            value={
