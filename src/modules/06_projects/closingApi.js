...
// 0 פעמים ב-src/ עד היום), קריאת איש-הקשר למיילי-הסגירה, ופרמטר קישור-הסקר.
//
...
// ערך פרמטר בודד מ-params (קישור-הסקר). לא getEmailTemplate — הודעת-הכשל שלו אומרת
// "תבנית המייל חסרה", וזה שקר על פרמטר-קישור; כאן ההודעה אומרת את הדבר עצמו.
