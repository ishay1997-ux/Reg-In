...
export const ZERO_QTY_MESSAGE =
  'הכמות חייבת להיות גדולה מאפס. להסרת פריט לגמרי — פני למנהלת הלוגיסטיקה.'
export const NON_INTEGER_MESSAGE = 'הכמות חייבת להיות מספר שלם.'
// 🔒 נעול ב-§3.7 של מדריך-המיקרו (וריאנט שינוי-התכולה — שונה במכוון מנוסח-הביטול).
export const EMPTY_REASON_MESSAGE = 'חובה למלא סיבה — היא מה שיסביר את החיוב הזה בעוד חודש.'
// הדפוס של מודול 3 ("עדכן ושלח" בלי שינוי — הכרעת-ישי 01/08/2026), בנוסח הכרטיס.
export const NO_CHANGE_MESSAGE = 'לא שינית אף כמות — אין מה לשמור'
