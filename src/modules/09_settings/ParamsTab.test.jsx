...
// בלי לגרור פיקסטורה בגודל הטבלה המלאה, שתתיישן בכל שינוי-Seed.
// ‏🔴 המספר הוסר 16/09/2026: כאן עמד "43", והטבלה עברה ל-47 כשמודול 11 הוסיף ארבעה פרמטרים.
//    הטיעון של ההערה לא תלוי במספר — ולכן המספר יורד ולא מתעדכן.
const ROWS = [
