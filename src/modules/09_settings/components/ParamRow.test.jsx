...
describe('ParamRow', () => {
  ...
  it('שורה שאינה במרשם מוצגת בשמה הגולמי ועם הערה גלויה — לעולם לא מוסתרת', () => {
    // ✏️ (לילה-הטקסטים, שלב 8): השורה השנייה שהייתה כאן ("שורה זו אינה מוכרת למרשם
    // התצוגה.") הוסרה מהרכיב — היא חזרה מילולית על מה ש-`entry.hint` כבר אומר (R27),
    // בניסוח שחושף מונח-פנימי ("מרשם"). מה שנשאר לבדיקה: השם הגולמי + ההסבר עדיין גלויים.
