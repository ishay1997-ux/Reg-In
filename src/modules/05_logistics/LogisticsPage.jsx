  ...
  return (
    <div data-testid="logistics-page">
      ...
      {/* ✏️ 24/09/2026 — "להזמין" בגובה-המסך הראשון (0ג פריט 4: *"מתחת לתור"* — אבל נמדד: עם 13 שורות-תור
          הבלוק התחיל ב-y=1441 בחלון 1536×864). **התיקון הקטן שלא נוגע בתור:** ברוחב ≥1360 הבלוק עומד
...
// ✏️ 09/09/2026, לילה-הטקסטים שלב 8 — **הבסיס המוסכם** (`ui-copy-and-onboarding-mode.md` §4
// שלב 8, הדוגמה המלאה): 254 תווים ⇒ משפט אחד. שני חוקי-הטריגר (⑳ + הטריגר השני של ㊶) והנימוק
// ל-01WEB שירדו מכאן **לא נמחקו** — הם מועמד לשכבת-ההטמעה (candidate ⑤/③, ראו הדיווח), ולא
// נכתבים כאן ולא ל-`onboardingCopy.js` הלילה. מי שנשארת אחראית להסביר טריגר-פר-שורה: הגליף
// (`amberGlyphTitle`, על not-started-פיזי בלבד) ושורת-הנימוק על השורה (על איחור-הגעה).
