 ...
 * **מסמך-ההצעה עצמה** — ✏️ 24/09/2026: `/quotes?view=:quoteId` (חלון-המסמך, בכל סטטוס), ולא
 * `/quotes/:quoteId/edit` כפי שהיה: מסך-העריכה עורך רק הצעה פתוחה, ושורות-הדוח הן הצעות שהוכרעו.
 *
