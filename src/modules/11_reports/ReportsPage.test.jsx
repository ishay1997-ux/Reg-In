...
describe('מ1 — מנתב-הדלתות', () => {
  ...
  // ✂️ 24/09/2026 (ליטושי-הכנס 0ג פריט 3): מ16 הוסר מהממשק, ואריח "דיילות פעילות" במ14 הצביע
  // עליו מהמסד (נמדד חי; מ-25/09 המסד שולח `target: null`, והרשת הזו נשארת בכוונה — הכרעת הסגן).
  // **יעד שהוסר במכוון ⇒ הערך נשאר, הדלת נעלמת** — בשונה מיעד לא-מוכר
