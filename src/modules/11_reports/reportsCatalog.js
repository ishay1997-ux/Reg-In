 ...
 * המשטח הזה בכלל"*, ו-24/09: *"מאשר הכל"*). אריח "דיילות פעילות" במ14 עדיין נושא
 * `target.report = 'report_m16_quality_cost'` (נמדד חי 24/09). ⚠️ **הפונקציה עצמה נשארת במסד**
 * עד אחרי מיזוג ל-`main` (Expand-Contract — `main` עדיין קורא לה), ואז `drop` במיגרציה נפרדת.
