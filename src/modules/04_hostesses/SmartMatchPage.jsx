  ...
  return (
    <div className="p-6" data-testid="smart-match-page">
      ...
      {/* 🔴 **המסך מודיע שהמרכיב כבוי, ואינו מעמיד פנים שהציון מלא** (§7.90) — כולל
          ...
          היום, ולכן הבאנר תמיד הופיע; בלי התנאי, ביום שהמרכיב יודלק (הדלקת `מרכיב_אמינות_פעיל`
          היא של מ9 — מ6 רק יוצר את נתוני-הנוכחות) הבאנר היה ממשיך להכריז שהוא כבוי בעוד
          הציון כבר משתמש בו. */}
      {params?.reliabilityEnabled === false && (
        ...
        >
          ...
          וגם תגית "מצוינת אצל הלקוח" עדיין ממתינה לנתונים — מסך סגירת-האירוע (מודול 6) שיוצר את
          הסימון כבר חי, והתגית תופיע מהסגירה הראשונה שתסמן דיילת כמצוינת.
        </div>
      )}
