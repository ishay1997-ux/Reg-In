    ...
    <div className="flex flex-col gap-6">
      <div className="bg-white rounded-2xl shadow-md p-6" data-testid="customers-list-card">
        ...
        {/* R-1: אותו דפוס בדיוק כמו הבאנר שמעליו. הנוסח נוקב במה שנעלם מהמסך — מסננת-הרדומים
            ועמודת-שביעות-הרצון — ולא ב"שגיאת טעינה" גנרית, כי המשתמשת רואה טבלה מלאה ותוהה מה חסר.
            ✏️ לילה-הטקסטים (09/09/2026): "עמודת ההתרשמות" תוקן ל"עמודת שביעות הרצון" — R11, המונח
            בעמודה עצמה (כותרת-הטבלה למטה ובכרטיס-הלקוח) הוא תמיד "שביעות רצון"; "התרשמות" לא הופיע
            במסך הזה בשום מקום אחר. */}
        {screenParamsFailed && (
          <div
            className="rounded-lg border border-amber-300 bg-amber-50 p-3 mb-4 flex items-center justify-between gap-3 flex-wrap"
            role="alert"
          ...
          >
            <p className="text-sm text-amber-800">
              הגדרות המסך לא נטענו — מסננת "לקוחות רדומים" ועמודת שביעות הרצון אינן זמינות כרגע.
            </p>
            <Button
              type="button"
              variant="outline"
