...
export function gapSentence(project) {
  ...
  // חוסר-לוגיסטיקה בלבד — יש שורות חיות כאלה (אופק 11/11 ו-13/13, screens-pass s08, 25/09/2026). ✅ הנוסח
  // אושר ע"י ישי 18/08/2026 (`module-6.md` §10, "הנחתי ②"), ושוב בסבב 2 של 25/09/2026 (בשיחת הסגן, 14:1X).
