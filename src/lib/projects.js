...
export function gapSentence(project) {
  ...
  // חוסר-לוגיסטיקה בלבד — ✏️ 25/09/2026: יש שורות חיות כאלה (אופק 11/11 ו-13/13, screens-pass s08). הנוסח
  // "הלוגיסטיקה טרם מוכנה" עדיין ממתין לאישור-ישי (הסגן מעביר את השאלה), ר' יומן-הסטיות.
