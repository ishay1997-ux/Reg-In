...
export function gapSentence(project) {
  ...
  // חוסר-לוגיסטיקה בלבד (אין שורה חיה כזאת היום) — ✅ אושר ע"י ישי 18/08/2026 (`module-6.md` §10, "הנחתי ②"),
  // ושוב בסבב 2 של 25/09/2026 (בשיחת הסגן, 14:1X). ההערה כאן "ממתין לאישור" פשוט לא עודכנה אז.
