...
export const PARAM_REGISTRY = [
  ...
  },
  {
    ...
    hint: 'כמה שעות לפני המשמרת תישלח לדיילת תזכורת אוטומטית (השליחה האוטומטית טרם נבנתה — הערך נשמר ומחכה לה)',
    kind: 'int',
    unit: 'שעות',
    min: 1,
  ...
  },
  {
    ...
    hint: 'כמה חודשים אחורה ייספרו לחישוב ציוני היענות ואמינות (החישוב טרם משתמש בערך הזה)',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
  ...
  },
  {
    ...
    hint: 'החלון המורחב שייפתח כשלדיילת אין מספיק תשובות בחלון הרגיל (טרם בשימוש)',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
