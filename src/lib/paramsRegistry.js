...
export const PARAM_REGISTRY = [
  ...
  // ── בקרה והתראות (12 — 8 + ארבע של מודול 11) ──
  {
    ...
    hint: 'אחוז מהתשלום לדיילת שמשולם לה כפיצוי כשהביטול חלקי, לא מלא',
    kind: 'percent',
    unit: '%',
    min: 0,
    max: 100,
  ...
  },
  {
    ...
    hint: 'ציון משוב שמתחתיו נדרשת סיבה ובירור טלפוני — לקוח שהממוצע שלו נמוך ממנו מסומן "טעון בירור"',
    kind: 'int',
    unit: '★',
    min: 1,
    max: 5,
    group: 'control_alerts',
    affects: 'משנה את הרף שממנו נדרשת סיבה למשוב — מסך הכספים ידרוש אותה',
  },
  {
  ...
  },
  {
    ...
    hint: 'אחוז החריגה מהתקציב שמעליו פרויקט מסומן כחורג בדוחות',
    kind: 'percent',
    unit: '%',
  ...
  },
  {
    ...
    hint: 'איזה חלק מממוצע-החברה הוא הגבול שמתחתיו ציון האמינות של דיילת נצבע ענבר — גבוה מהמקדם האדום',
    kind: 'weight',
    min: 0,
    max: 1,
    decimals: 2,
  ...
  },
  {
    ...
    label: 'סף אירוע דחוף',
    hint: 'כמה שעות לפני האירוע הוא נחשב "דחוף" במבט-העל ובמיון',
    kind: 'int',
    unit: 'שעות',
    min: 1,
  ...
  // ── התאמת דיילות (13) ──
  {
    ...
    decimals: 2,
    group: 'smart_match',
    // ✏️ 25/09/2026: נכון מאז שברירת-המחדל היא "המלצת המערכת" (סדר-הציון). הסייג — כי באירוע
    // דחוף המסך נפתח על "תענה הכי מהר", והמשקולות לא מזיזות אותו. בלי "72": זה פרמטר
    // (`שעות_אירוע_דחוף`), ומספר קפוא כאן היה משקר ביום שישנו אותו.
    affects:
      "משנה את סדר המועמדות שמנהלת השיבוץ תראה מחר במסך ההתאמה (באירוע דחוף המסך נפתח על 'תענה הכי מהר')",
  },
  {
    name: 'משקולת_אמינות',
    label: 'משקולת אמינות',
  ...
  },
  {
    ...
    hint: 'כמה חודשים אחורה ייספרו לחישוב ציוני היענות ואמינות',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
    max: 60,
  ...
  },
  {
    ...
    hint: 'החלון המורחב שייפתח כשלדיילת אין מספיק תשובות בחלון הרגיל',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
    max: 60,
  ...
  },
  {
    ...
    hint: 'כמה תשובות נדרשות לפני שמוצג ציון — פחות מזה מוצג "דיילת חדשה"',
    kind: 'int',
    unit: 'תשובות',
    min: 1,
