...
export const PARAM_REGISTRY = [
  ...
  },
  {
    ...
    label: 'טווח חישוב',
    // 🔴 כנ"ל — הערך נשמר, ואף חישוב אינו קורא אותו היום (ר' ההערה ליד `max`).
    hint: 'כמה חודשים אחורה ייספרו לחישוב ציוני היענות ואמינות — הערך נשמר, החישוב טרם משתמש בו',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
  ...
  },
  {
    ...
    // 🔴 כנ"ל — נשמר ואינו נקרא.
    hint: 'החלון המורחב שייפתח כשלדיילת אין מספיק תשובות בחלון הרגיל — הערך נשמר, טרם בשימוש',
    kind: 'int',
    unit: 'חודשים',
    min: 1,
