...
// ✏️ 16/09/2026 — **מיוצא** (צעד 3.3 של מ11): `report_m15_reliability` מחזיר `dow` 0–6 עם
// `chart.label_source: 'WEEKDAY_NAMES_HE'` (C8), והלשונית ממפה דרך הקבוע הזה. בלי הייצוא
// ציר יום-בשבוע היה מרונדר `0 1 2 3 4 5`. **שום דבר אחר בקובץ לא השתנה.**
