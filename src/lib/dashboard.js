...
const ATTENTION_CATEGORY_DEFS = [
  ...
  // (`PROJECT_STATUS_LABELS.event_finished`, מה שמסך הפרויקטים מציג).
  {
    ...
    href: '/projects',
    tone: 'yellow',
    // ✏️ 25/09/2026 (הבודק, דרך הסגן): "8 ממתין לסגירה" היה עברית שבורה ⇒ משפט-ספירה ביחיד/רבים, כמו שאר הכרטיסים;
    // שם-הסטטוס עצמו נשאר בתוויות-הסטטוס של הפרויקטים.
    noun: 'פרויקטים ממתינים לסגירה',
    nounOne: 'פרויקט ממתין לסגירה',
    // ✏️ 25/09/2026 (הכרעת הסגן): שם-הסטטוס נשאר בשורות; רק משפט-הריק צריך עברית שלמה ("✓ אין ממתין לסגירה").
    emptyNoun: 'פרויקטים שממתינים לסגירה',
  },
  {
    kind: 'staffing',
    label: 'דיילות',
