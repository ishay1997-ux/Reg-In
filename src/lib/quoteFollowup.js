...
// ‏30 שניות, כמו `EMAIL_SEND_TIMEOUT_MS`: לפונקציית-השרת יש תקציב של 24 שניות משלה
// (`draft-followup/index.ts` `BUDGET_MS`), כך שהשרת תמיד עונה לפני שהחלון מוותר.
// היעד בפועל הוא ≤10 שניות (התוכנית §6ה-ה) — זו התקרה, לא הזמן הצפוי.
export const FOLLOWUP_DRAFT_TIMEOUT_MS = 30_000
