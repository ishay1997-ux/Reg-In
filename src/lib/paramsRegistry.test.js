...
describe('תקרות מספריות — 20 מוגנות, ושתיים פתוחות בהכרעת-ישי', () => {
  const OPEN_BY_RULING = ['סף_לקוח_רדום_ימים', 'תקרת_שבועות_הוגנות']
  ...
  it('כל פרמטר מספרי נושא תקרה — פרט לשניים שהוכרעו במפורש', () => {
