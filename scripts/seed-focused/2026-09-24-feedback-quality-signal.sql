...
-- ═══ ③ חזרה (מהגיבוי) ════════════════════════════════════════════════════════════════
-- ⚠️ משחזר 3 עמודות בלבד; לא מבטל את `20260924110000` ⇐ 43 הערות שנכתבו מחדש ו-27 סיבות-שליליות נשארות ליד ציון שחוזר. נתיב-חירום — לבנות שחזור מלא רק אם ייבחר.
--    (✏️ 25/09/2026, הכרעת הסגן, מממצאי ההרצות-היבשות: `Reg-In-evidence\reports-review-2026-09-25\dry-runs-2026-09-25.md`.)
-- begin;
-- set local session_replication_role = replica;
-- update public.projects p
