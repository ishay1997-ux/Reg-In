...
-- ⚠️ **לא מכוסה בשלב הזה — הלוגיסטיקה** (נמדד 24/09, קריאה בלבד): בטווח יש 2 שורות-ציוד "מוכן" עם
--    "הגיע" = 0 ובלי מילוי-אוטומטי, מאותה ריצת-אופק של 10/09 שתוקנה ב-
--    `20260924233500_seed_logistics_arrived_2026_09.sql`: 1594 SAT-LAN 420 (22/09) · 1597 FAB-LAN 100 (28/09).
--    ביום הכנס שתיהן "נסגרו" (מעל שבוע) ⇐ מ12 ("צריכת ציוד") יספור 520 יחידות חסרות שלא חסרו.
