 ...
 */
// 🧹 10/09/2026: חמשת הפטורים שישבו כאן (GHSA-rgw5-rvv9-x895 · GHSA-7p8r-x3mc-p8w7 ·
// GHSA-mwp4-54f8-5fhr · GHSA-8xcm-r25x-g524 · GHSA-5p4m-2wfm-xmqj) הוסרו — השער עצמו
// דיווח על כולם כ"אינו תואם עוד לאף חולשה" (npm audit חדל למצוא את החולשות המקוריות;
// התלויות שנשאו אותן עודכנו בדרך). באותה ריצה תוקנה גם חולשה חדשה וממשית:
// GHSA-7w5x-hrqm-74c2 (smol-toml, DoS על TOML מעוות) — הגיעה דרך knip@6.29.0, שמצהיר
